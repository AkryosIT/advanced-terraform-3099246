...
gcloud iam service-accounts create terraform-cloud \
 ...
 gcloud projects add-iam-policy-binding terraformlabs-447312 \
    --member="serviceAccount:terraform-cloud@terraformlabs-447312.iam.gserviceaccount.com" \
    --role="roles/owner"

gcloud iam service-accounts keys create tf_sa_key \
    --iam-account=terraform-cloud@terraformlabs-447312.iam.gserviceaccount.com
```